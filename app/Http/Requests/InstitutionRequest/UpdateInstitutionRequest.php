...
class UpdateInstitutionRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            //
            'name' => 'sometimes|string|min:5|max:90|regex:/^[\pL\pM\s]+$/u|unique:institutions,name',//acepta mayusculas y minusculas, espacios y letras con acentos
            'geocode' => 'sometimes|digits_between:5,15',
            'municipality' => 'sometimes|string|min:5|max:40|regex:regex:/^[\pL\pM\s,]+$/u',//acepta mayusculas y minusculas, espacios y letras con acentos,comas 
            'typeinst' => 'sometimes|string|min:5|max:20|regex:/^[\pL\pM\s,]+$/u',//acepta mayusculas y minusculas, espacios y letras con acentos,comas 
        ];
    }
