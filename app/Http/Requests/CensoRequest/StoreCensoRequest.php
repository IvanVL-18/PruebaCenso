...
class StoreCensoRequest extends FormRequest
{
    ...
    {
        return [
            'name' => 'required|string|min:5|max:65|regex:/^[\pL\pM\pN\s\'\-\.\,\/\(\)]+$/u|unique:censos,name',// Acepta mayúsculas, minúsculas, letras con acentos, números, espacios y signos básicos (',.-/())
            'description' => 'nullable|string|min:10|max:255|regex:/^[\pL\pM\pN\s\'\-\.\,\/\(\)]+$/u',// Acepta mayúsculas, minúsculas, letras con acentos, números, espacios y signos básicos (',.-/())
